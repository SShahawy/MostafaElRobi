                ...
                <div class="content-menu" style="background-color: white !important;">
                    <div class="nav-wrap">
                        ...
                        <nav  id="mainnav" class="mainnav"  >
                            <ul class="menu" >
                                <li>
                                    <a href="#footer" class="" style="font-weight: bold;font-size:20px !important;">للتواصل</a>
                                    {{-- <ul class="sub-menu">
                    ...
                    <div class="bnc" style="" >
                        <div class="iconbox-wrap">
                            <div class="iconbox-icon" >
                                <img src="images/icon/law-hammer.png" alt="law hammer" style="height: 150px;">
                            </div>
  ...
  <div class="case-evaluation" id = "cont"> 
    ...
    <footer id="footer" class="footer" style=" background-image: linear-gradient(to left,#cca776c4,#3c1e13d7) !important;">
        ...
        <a id="scroll-top" class="show">
            ...
            <img src="images/icon/up-arrow.png"  height="70px" width="70px"  >
        </a>
