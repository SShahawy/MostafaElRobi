            ...
            <div class="content-menu" style="background-color: white !important;">
                <div class="nav-wrap">
                    ...
                    <nav  id="mainnav" class="mainnav" >
                        <ul class="menu" >
                            <li>
                                <a href="#footer" class="" >للتواصل</a>
                                {{-- <ul class="sub-menu">
                                    <li><a href="index.html" class="active">Home 1</a></li>
                                </ul> --}}
                            </li>
                            <li>
                                <a href="/hire" class="">توظيف و ندريب</a>
                                {{-- <ul class="sub-menu">
                                    <li><a href="index.html" class="active">Home 1</a></li>
                                </ul> --}}
                            </li>
                            <li>
                                <a href="/h6" class="">اسئله شائعه</a>
                                {{-- <ul class="sub-menu">
                                    <li><a href="index.html" class="active">Home 1</a></li>
                                </ul> --}}
                            </li>
                            <li>
                                <a href="/#rev" class="">اراء عملائنا</a>
                                {{-- <ul class="sub-menu">
                                    <li><a href="index.html" class="active">Home 1</a></li>
                                </ul> --}}
                            </li>
                            <li>
                                <a href="/request">احجز استشاره</a>
                                {{-- <ul class="sub-menu">
