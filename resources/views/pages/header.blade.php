    ...
    <header id="header" style="background-image:linear-gradient(to right,#FAE9D5,#DDD9D6,white) !important;" class="header bg-color">
                    ...
                    <div class="nav-wrap" >
                        ...
                        <nav  id="mainnav" class="mainnav"  >
                            <ul class="menu"  >
                                ...
                                <li>
                                    <a href="/" class="nav-texts">الرئيسيه</a>
                                ...
                                <li>
                                    <a href="/company-open" class="nav-texts">اسس شركتك</a>
                                
                                </li>
                                <li>
                                    <a href="/hire" class="nav-texts">توظيف</a>
                                
                                </li>
                                <li>
                                    <a href="/services" class="nav-texts">الخدمات</a>
                                
                                </li>
                                <li>
                                    <a href="/h6" class="nav-texts" >فديوهات هامة</a>
