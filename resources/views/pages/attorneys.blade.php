                    ...
                    <div class="nav-wrap">
                        ...
                        <nav  id="mainnav" class="mainnav"  >
                            <ul class="menu" >
                                ...
                                <li>
                                    <a href="index.html" class="" style="font-weight: bold;font-size:20px !important;">توظيف و ندريب</a>
                                    {{-- <ul class="sub-menu">
                                        <li><a href="index.html" class="active">Home 1</a></li>
                                    </ul> --}}
                                </li>
                                <li>
                                    <a href="index.html" class="" style="font-weight: bold;font-size:20px !important;">اراء عملائنا</a>
                                    {{-- <ul class="sub-menu">
                                        <li><a href="index.html" class="active">Home 1</a></li>
                                    </ul> --}}
                                </li>
                                <li>
                                    <a href="index#cont" style="font-weight: bold;font-size:20px !important;">احجز استشاره</a>
                                    {{-- <ul class="sub-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="/index#att">فريق العمل</a></li>
                                    </ul>
                                </li>
                                <li>
